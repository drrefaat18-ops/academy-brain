...
SCHEMA='Return ONLY valid JSON (no markdown fence) matching this shape: {"cluster":"<ID>","provider":"gemini","claims":[{"claim":"<research finding, one sentence>","source":"<URL or MID:principle-name>","applies_to":["L1-sN", ...]}]}. Every claim MUST have a source. 3-8 claims. No prose outside the JSON.'
